      ...
      >
        {loading ? (
          ...
          <div className="relative w-full lg:w-[60%] mx-auto rounded-sm border-2 py-[30px] px-[10px] md:px-[30px]">
            <div
              className={`p-4 rounded-md dark:bg-gray-700 dark:border-gray-600 bg-white border-gray-300 `}
            >
              <h3
                className={`border-b font-bold md:text-[20px] dark:border-gray-600 dark:text-white border-gray-300 text-[#434343] `}
              >
                Reset Password
              </h3>
                  ...
                  {({ isSubmitting, errors, touched }) => (
                    <Form className="text-[13px]">
                      <div className="relative w-full flex flex-col gap-[5px]">
                        <label
                          className={`w-full font-bold dark:text-white text-[#434343] `}
                          htmlFor="password"
                        >
                          Password:
                        </label>
                      ...
                      <div className="py-[25px] flex gap-4">
                        ...
                        <div
                          className={`flex my-auto text-[12px] md:text-[14px] dark:text-white text-[#434343] `}
                        >
                          <span>or </span>
                          <Link
                            href="/login"
                            className={`ml-[5px] underline dark:text-red-400 text-[#FF2E51`}
                          >
                            Login
                          </Link>
                        </div>
