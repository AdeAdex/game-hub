...
const SearchBox: React.FC<SearchBoxProps> = ({
  ...
  return (
    <div className={`${ClassName}`}>
      ...
      {query && (
        <ul className={`absolute top-[55px] left-50 w-[20%] mt-1 overflow-y-auto max-h-screen ${theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-black"} border ${theme === "dark" ? "border-gray-700" : "border-gray-300"} rounded-md shadow-lg z-50`}>
