  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="max-w-md p-8 bg-white rounded-lg shadow-lg text-center">
        <div className="text-red-600 text-6xl mb-4 animate-pulse">
          <FaExclamationCircle />
        </div>
        ...
        <button
          onClick={goBackHome}
          className="px-6 py-3 bg-red-600 text-white rounded hover:bg-red-700 focus:outline-none focus:bg-red-700"
        >
          Go Back to Home
        </button>
      </div>
