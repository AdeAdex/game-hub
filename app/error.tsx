  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="max-w-md p-8 bg-white rounded-lg shadow-lg text-center">
        <div className="text-red-600 text-6xl mb-4"><FaExclamationCircle /></div>
        ...
        <p className="text-gray-700 mb-6">Don't worry, our team has been notified and we'll work on fixing it. In the meantime, you can try refreshing the page or go back to the home page.</p>
